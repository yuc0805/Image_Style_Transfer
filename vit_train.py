...
#raise ValueError('end of the code')
...
with torch.no_grad():
    ...
    network = StyTR.StyTrans(vit,decoder,embedding, Trans,args)
network.train()
...
#python vit_train.py --style_dir monet2photo/testA/ --content_dir monet2photo/testB/ --save_dir models/ --batch_size 2 --n_threads 0